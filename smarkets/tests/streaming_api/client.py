...
SUCCESSFUL_LOGIN_RESPONSE_RAW = bytearray(
    b'@\x08\x01\x12<\x08\x01\x10\x08\x18\x0024\n\x129RK4DpIK9HY5FpZKTo\x10\x02\x1a\x13hanson'
    b'@smarkets.com \x93\xa7\xb1\xc5\xa9\xa6\xd2\x18\x14\x08$\x12\x04\x08\x02\x18\x00\xaa\x02'
    b'\t\x08\xf4\x03\x10\xe8\x07\x18\xc8\x01\n\x08\x01\x12\x06\x08\x03\x10\x05\x18\x00\n\x08'
    b'\x01\x12\x06\x08\x04\x10\x05\x18\x00')
UNAUTHORIZED_LOGIN_RESPONSE_RAW = bytearray(
    b'\x0e\x08\x01\x12\n\x08\x01\x10\t\x18\x00:\x02\x08\x07')
PAYLOAD_THROTTLE_LIMITS_RAW = bytearray(
    b'\x14\x08$\x12\x04\x08\x02\x18\x00\xaa\x02\t\x08\xf4\x03\x10\xe8\x07\x18\xc8\x01')
...
class SmarketsTestCase(unittest.TestCase):
    ...
    def test_login_ok(self):
        ...
        self.client.session.next_frame = read_session_buff_gen(SUCCESSFUL_LOGIN_RESPONSE_RAW)
        self.client.login()
    ...
    def test_login_unauthorized(self):
        "Test the `Smarkets.login` method for unauthorized"
        self.client.session.next_frame = read_session_buff_gen(UNAUTHORIZED_LOGIN_RESPONSE_RAW)
        try:
            self.client.login()
